...
**Status**: PR1 MERGED `1634eceb` (#77, 2026-09-18). PR2 = #78 open (branch `feat/ipad-hardware-shortcuts`). PR3 = #79 open (branch `feat/ipad-hardware-caret`, stacked on PR2). TPS hardware mapping closed — not built (USER 2026-09-18). Dogfood S47 / S48 pending (USER 2026-09-18 「最後再 dogfood」).
