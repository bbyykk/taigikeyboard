...
pub use continuous::{
    ...
    fetch_partial_prefix_candidates_unbounded, CandidateMode, ConsumedSpan, ContinuousFetchCtx,
    CustomEntry, EdgeBest, RawCandidate, TonePin, COVERAGE_KIND_FULL, COVERAGE_KIND_PARTIAL_PREFIX,
