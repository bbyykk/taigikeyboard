...
| Font Awesome Free 6.7.2 icon path data (`globe`, `github`, `discord`, `envelope`) | `macos/Sources/TaigiInputMethodCore/Settings/FontAwesomeGlyph.swift`, `windows/crates/taigi-windows-settings/src/winui/font_awesome.rs` | CC BY 4.0 | © 2024 Fonticons, Inc. (<https://fontawesome.com/license/free>) |
...
The Font Awesome path data draws the 關於 page's website, GitHub, Discord and
email links on macOS and Windows. Both files carry the attribution comment
