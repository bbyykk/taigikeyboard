...
| Font Awesome Free 6.7.2 icon path data (`github`, `discord`, `envelope`) | `macos/Sources/TaigiInputMethodCore/Settings/FontAwesomeGlyph.swift`, `windows/crates/taigi-windows-settings/src/winui/font_awesome.rs` | CC BY 4.0 | © 2024 Fonticons, Inc. (<https://fontawesome.com/license/free>) |
...
The Font Awesome path data draws the settings footer's GitHub, Discord and
